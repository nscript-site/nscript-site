...
- [NewBeeDB](https://github.com/nscript-site/NewBeeDB) (Chinese: 牛逼 DB) : A lightweight vector database written with pure C#, compatible with NativeAOT
- [NewBeeTA](https://github.com/nscript-site/NewBeeTA) (Chinese: 牛逼 BS) : AI trading agents platform based on blazor server
- [NewBeeVG](https://github.com/nscript-site/NewBeeVG) (Chinese: 牛逼 VG) : Programmatic visual/video contents generation tool based on NewBee UI, facilitating video generation through AI programming.
